<template>
    ...
    <main class="bg-gray-100 h-screen p-10">
        ...
        <h1 class="font-bold text-2xl">Crear Publicacion</h1>
        <p class="text-gray-500 text-lg mb-5">¡Es hora de crear una guía! Lucete!</p>
        ...
        <section>
            <form @submit.prevent="uploadPost">
                ...
                <ckeditor v-model="postContent" :editor="ClassicEditor" :config="config" />
        ...
        <aside class="mt-5 max-w-2xl text-justify">
            <h2 class="font-bold text-2xl">Manual de Usuario</h2>
            <p class="text-gray-500 text-lg">Saludos familia, aquí van a poder crear las guías. Podrán agregar contenido
                a como deseen
                Tienen a su disposición las herramientas básicas pero que son las útiles para las guías, como por
                ejemplo: agregar imagenes, tablas, estilar el texto.
